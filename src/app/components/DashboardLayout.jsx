...
import { Train, Upload, Search, History, LogOut, Menu, X, Wallet, ShieldCheck, Users } from 'lucide-react';
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            return (<button key={item.id} onClick={() => onTabChange(item.id)} className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors ${activeTab === item.id
            ...
            <div className="flex items-center space-x-4">
              {/* Wallet Balance */}
              {user.role !== 'admin' && (<div className="hidden sm:flex items-center space-x-2 bg-green-50 px-3 py-1.5 rounded-lg border border-green-200">
              ...
              {/* Logout Button */}
              <Button variant="ghost" size="sm" onClick={logout} className="hidden md:flex items-center space-x-2">
        ...
        {mobileMenuOpen && (<div className="md:hidden border-t border-gray-200 bg-white">
            <div className="container mx-auto px-4 py-4">
              ...
              {/* Wallet Balance */}
              {user.role !== 'admin' && (<div className="flex items-center space-x-2 bg-green-50 px-3 py-2 rounded-lg border border-green-200 mb-4">
                  <Wallet className="size-4 text-green-600"/>
              ...
              {/* Logout */}
              <button onClick={logout} className="w-full flex items-center space-x-3 px-4 py-3 mt-4 text-red-600 hover:bg-red-50 rounded-lg transition-colors">
